  ...
  return (
    <div className="min-h-screen p-4 max-w-2xl mx-auto py-8 bg-background">
      ...
      <div className="space-y-6 text-sm text-card-foreground leading-relaxed">
        ...
        {/* ===== 重要: 免責事項・サービスの性質 ===== */}
        <section className="rounded-xl border-2 border-primary/60 bg-card p-5 shadow-[0_0_14px_rgba(255,166,35,0.25)]">
        ...
        {/* ===== ロードマップ開示 ===== */}
        <section className="rounded-xl border border-[#3498db]/40 bg-card p-5">
          <h2 className="text-lg font-semibold text-[#5dade2] mb-3">📋 開発ロードマップ</h2>
          <p className="text-card-foreground mb-3">本アプリの開発ロードマップを以下に開示します（透明性のため）:</p>
          <div className="space-y-2">
            <div className="flex items-start gap-2">
              <span className="bg-[#3498db] text-white text-xs font-bold px-2 py-0.5 rounded-full mt-0.5 flex-shrink-0">現在</span>
              <div>
                <p className="font-semibold text-[#5dade2]">Phase 1: アプリ内記録管理</p>
                <p className="text-muted-foreground text-xs">お手伝い記録 + 外部送金アプリへのリンク（PayPay / B/43 / LINE Pay等）</p>
              </div>
            </div>
            <div className="flex items-start gap-2">
              <span className="bg-muted text-muted-foreground text-xs font-bold px-2 py-0.5 rounded-full mt-0.5 flex-shrink-0">将来</span>
              <div>
                <p className="font-semibold text-muted-foreground">Phase 2: プリペイドカード連携・銘柄拡充</p>
                <p className="text-muted-foreground/80 text-xs">B/43ジュニア等との連携、投資シミュレーション銘柄の拡充（予定）</p>
              </div>
            </div>
            <div className="flex items-start gap-2">
              <span className="bg-muted text-muted-foreground text-xs font-bold px-2 py-0.5 rounded-full mt-0.5 flex-shrink-0">将来</span>
              <div>
                <p className="font-semibold text-muted-foreground">Phase 3: 銀行API連携・銘柄本格拡充</p>
                <p className="text-muted-foreground/80 text-xs">資金移動業ライセンス取得後の実装予定、投資銘柄の本格拡充</p>
              </div>
            </div>
          </div>
          <p className="text-xs text-[#5dade2]/80 mt-3 border-t border-[#3498db]/30 pt-2">
        ...
        {/* ===== サービス概要 ===== */}
        <section>
          <h2 className="text-lg font-semibold text-primary mb-2">1. サービス概要</h2>
        ...
        {/* ===== 対象年齢 ===== */}
        <section>
          <h2 className="text-lg font-semibold text-primary mb-2">2. 対象年齢・利用条件</h2>
        ...
        {/* ===== アカウント管理 ===== */}
        <section>
          <h2 className="text-lg font-semibold text-primary mb-2">3. アカウント管理</h2>
          <ul className="list-disc pl-6 space-y-1">
        ...
        {/* ===== 投資シミュレーション ===== */}
        <section>
          <h2 className="text-lg font-semibold text-primary mb-2">4. 投資シミュレーションについて</h2>
          <div className="rounded-lg border border-primary/40 bg-secondary/60 p-3">
        ...
        {/* ===== 禁止事項 ===== */}
        <section>
          <h2 className="text-lg font-semibold text-primary mb-2">5. 禁止事項</h2>
          <ul className="list-disc pl-6 space-y-1">
        ...
        {/* ===== 免責事項 ===== */}
        <section>
          <h2 className="text-lg font-semibold text-primary mb-2">6. 免責事項</h2>
          <ul className="list-disc pl-6 space-y-1">
        ...
        {/* ===== サービス変更・終了 ===== */}
        <section>
          <h2 className="text-lg font-semibold text-primary mb-2">7. サービスの変更・終了</h2>
          <ul className="list-disc pl-6 space-y-1">
        ...
        {/* ===== 規約の変更 ===== */}
        <section>
          <h2 className="text-lg font-semibold text-primary mb-2">8. 規約の変更</h2>
